	...
	function getterAndSetter() {
		...
		$scope.gridOptions = {
			...
			columnDefs: [
				...
				{ name: "SLCSEEype", displayName: "SLC/SEE", minWidth: 140, headerCellClass: 'headerAligment' },
				{ name: "PlusTwoType", displayName: "Plus 2", minWidth: 140, headerCellClass: 'headerAligment' },
			],
