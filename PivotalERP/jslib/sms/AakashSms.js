...
app.controller('aakashSmSCntl',function ($scope, $http, $filter) {
        ...
        // Load all messages (recursively fetch all pages)
        ...
        $scope.exportToCSV = function () {
            ...
            window.location.href = '/Sms/ExportToCsv?' +
