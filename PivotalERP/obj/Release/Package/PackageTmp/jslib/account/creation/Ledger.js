...
app.controller('Ledger', function ($scope, $http, $timeout, $filter, GlobalServices) {
	...
	$scope.LoadData = function () {
		...
		$scope.VoucherSearchOptions = [{ text: 'Name', value: 'Led.Name', searchType: 'text' }, { text: 'Alias', value: 'Led.Alias', searchType: 'text' }, { text: 'Code', value: 'Led.Code', searchType: 'text' }, { text: 'PanVat', value: 'LS.PanVatNo', searchType: 'text' }];
