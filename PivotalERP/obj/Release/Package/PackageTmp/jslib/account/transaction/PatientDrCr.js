app.controller('PatientDrCrController', function ($scope, $http, $timeout, $filter, GlobalServices) {
    $scope.Title = 'Patient Debit/Credit';
    ...
    $scope.GetPatientById = function () {
        $scope.beData.LedgerAllocationColl[0].PatientId = null;
        $scope.beData.LedgerAllocationColl[0].PatientNo = null;
        $scope.beData.LedgerAllocationColl[0].PatientName = null;
        $scope.beData.LedgerAllocationColl[0].PatientAddress = null;
        $scope.beData.LedgerAllocationColl[0].Narration = null;
        ...
        if ($scope.beData.RefNo && $scope.beData.RefNo.length > 0) {
            ...
            $http({
                ...
                if (patient.IsSuccess == true) {
                    ...
                    $scope.beData.LedgerAllocationColl[0].PatientId = patient.PatientId;
                    $scope.beData.LedgerAllocationColl[0].PatientNo = $scope.beData.RefNo;
                    $scope.beData.LedgerAllocationColl[0].PatientName = patient.PatientName;
                    $scope.beData.LedgerAllocationColl[0].PatientAddress = patient.Address;
                    $scope.beData.LedgerAllocationColl[0].Narration = patient.MobileNo;
                    ...
                    $timeout(function () {
                        $scope.$apply(function () {
                            if ($scope.SelectedVoucher) {
                                ...
                                $scope.beData.LedgerAllocationColl[1].LedgerId = $scope.SelectedVoucher.VoucherTranLedgerId;
                                $scope.beData.LedgerAllocationColl[0].LedgerId = $scope.SelectedVoucher.VoucherPartyLedgerId;
    ...
    $scope.IsValidData = function () {
        ...
        if ($scope.beData.Narration.isEmpty()==true) {
            result = false;
    ...
    $scope.GetData = function () {
        ...
        if ($scope.beData.LedgerAllocationColl[0].DrCr == 1) {
            $scope.beData.LedgerAllocationColl[0].DrAmount = $scope.beData.LedgerAllocationColl[0].Amount;
            $scope.beData.LedgerAllocationColl[0].CrAmount = 0;

            $scope.beData.LedgerAllocationColl[1].CrAmount = $scope.beData.LedgerAllocationColl[0].Amount;
            $scope.beData.LedgerAllocationColl[1].DrAmount = 0;
            $scope.beData.LedgerAllocationColl[1].DrCr = 2;

        } else {
            $scope.beData.LedgerAllocationColl[0].CrAmount = $scope.beData.LedgerAllocationColl[0].Amount;
            $scope.beData.LedgerAllocationColl[0].DrAmount = 0;

            $scope.beData.LedgerAllocationColl[1].DrAmount = $scope.beData.LedgerAllocationColl[0].Amount;
            $scope.beData.LedgerAllocationColl[1].CrAmount = 0;
            $scope.beData.LedgerAllocationColl[1].DrCr = 1;
        }
