...
app.controller("OneLakhAboveSalesCTRL", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
...
$timeout(function () {
    ...
    $scope.GetAccountConfirmationLetter = function () {
        ...
        $http({
            method: "post",
            url: base_url + "Account/Reporting/GetOneLakhAboveSales",
    ...
    $scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "OneLakhAboveSales.xlsx");
            }
