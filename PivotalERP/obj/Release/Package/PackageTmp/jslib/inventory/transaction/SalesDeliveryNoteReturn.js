app.controller('DeliveryNoteReturnController', function ($scope, $http, $timeout, $filter, GlobalServices) {
    ...
    $scope.getRefVoucherPartyDetails = function (tranId) {
        ...
        if ($scope.beData.RefVoucherType && tranId > 0) {
            ...
            var funName = "getDeliveryNotePartyDetails";
            ...
            $http({
                ...
                if (res1.data.IsSuccess && res1.data.Data) {
                    ...
                    if (refVType == 1) {
                        ...
                        $scope.beData.DeliveryNoteReturnDetail.Description = tmpdata.RefNo;

                        $scope.beData.DeliveryNoteReturnDetail.Goods = tmpdata.DeliveryNoteDetail.RegdNo;

                        $scope.beData.DeliveryNoteReturnDetail.Buyes = tmpdata.DeliveryNoteDetail.Buyes;
                        $scope.beData.DeliveryNoteReturnDetail.Address = tmpdata.DeliveryNoteDetail.Address;
                        $scope.beData.DeliveryNoteReturnDetail.PhoneNo = tmpdata.DeliveryNoteDetail.PhoneNo;
                        $scope.beData.DeliveryNoteReturnDetailSalesTaxNo = tmpdata.DeliveryNoteDetail.SalesTaxNo;

                        $scope.beData.DeliveryNoteReturnDetail.DriverName = tmpdata.DeliveryNoteDetail.DriverName;
                        $scope.beData.DeliveryNoteReturnDetail.DriverContactNo = tmpdata.DeliveryNoteDetail.DriverContactNo;
                    }
