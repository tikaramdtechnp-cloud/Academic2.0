...
app.controller('PurchaseAnalysisController', function ($scope, $http, $timeout, $filter, GlobalServices, $compile) {
    $scope.Title = 'Purchase Analysis';
    ...
    function getterAndSetter()
    {
        var columnDefs = [
            ...
            { headerName: "Purchase Qty", width: 120, field: "InQty" },
            { headerName: "Purchase Rate", width: 120, field: "InRate" },
            { headerName: "Purchase Amt", width: 120, field: "InAmt" },
            { headerName: "Return Qty", width: 120, field: "OutQty" },
            { headerName: "Return Rate", width: 120, field: "OutRate" },
            { headerName: "Return Amt", width: 120, field: "OutAmt" },
            { headerName: "Net Purchase Qty", width: 140, field: "BalanceQty" },
            { headerName: "Unit", width: 120, field: "Unit" },
            { headerName: "Net Purchase Rate", width: 140, field: "BalanceRate" },
            { headerName: "Net Purchase Amt", width: 140, field: "BalanceAmt" },
        ...
        var columnDefs2 = [
            ...
            { headerName: "PurchaseQty", width: 120, field: "SalesQty" },
            { headerName: "PurchaseRate", width: 120, field: "SalesRate" },
            { headerName: "PurchaseAmt", width: 120, field: "SalesAmt" },
            { headerName: "ReturnQty", width: 120, field: "ReturnQty" },
            { headerName: "ReturnAmt", width: 120, field: "ReturnAmt" },
            { headerName: "ReturnRate", width: 120, field: "ReturnRate" },
            { headerName: "Net Purchase Qty", width: 120, field: "NetSalesQty" },
            { headerName: "BalanceRate", width: 120, field: "BalanceRate" },
            { headerName: "Net Purchase Amt", width: 120, field: "NetSalesAmt" },
        ];
    ...
    $scope.GetProductWise = function () {
        ...
        $http({
            method: "post",
            url: base_url + "Inventory/Reporting/GetPurchaseAnalysisProductWise",
                                ...
                                return new Promise((resolve) => {
                                    if (value >= 0) {
                                        ...
                                        if (rptTranId > 0) {
                                            ...
                                            $http({
                                                method: 'POST',
                                                url: base_url + "Inventory/Reporting/PrintPurchaseAnalysisProductWise",
    ...
    $scope.GetProductGroupWise = function () {
        ...
        $http({
            method: "post",
            url: base_url + "Inventory/Reporting/GetPurchaseAnalysisProducGrouptWise",
            data: JSON.stringify(para),
            dataType: "json"
        }).then(function (res) {
    ...
    $scope.GetPartyWiseWise = function () {
        ...
        $http({
            method: "post",
            url: base_url + "Inventory/Reporting/GetPurchaseAnalysisPartyWise",
            data: JSON.stringify(para),
            dataType: "json"
        }).then(function (res) {
