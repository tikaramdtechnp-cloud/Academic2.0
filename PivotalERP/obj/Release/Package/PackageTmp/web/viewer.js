...
var DEFAULT_URL =  '../newpdfviewer.ashx';
//var DEFAULT_URL = '@Session["reporthandler"]';
//var DEFAULT_URL = document.getElementById("session").value;
  ...
  PDFPageView.prototype = {
    ...
    cssTransform: function PDFPageView_transform(canvas, redrawAnnotations) {
      ...
      if (redrawAnnotations && this.annotationLayer) {
          //this.annotationLayer.render(this.viewport, 'display'); on 2019-01-20 Sachin Sah
          this.annotationLayer.render(this.viewport, 'print');
      }
    },
...
var AnnotationsLayerBuilder = (function AnnotationsLayerBuilderClosure() {
  ...
  AnnotationsLayerBuilder.prototype =
    ...
    render: function AnnotationsLayerBuilder_render(viewport, intent) {
      var self = this;
      var parameters = {
          //intent: (intent === undefined ? 'display' : intent), on 2019-01-20 Sachin Sah
          intent: (intent === undefined ? 'print' : intent),
      };
