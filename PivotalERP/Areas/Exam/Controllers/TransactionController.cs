...
namespace PivotalERP.Areas.Exam.Controllers
{
    public class TransactionController : PivotalERP.Controllers.BaseController
    {
        ...
        [HttpPost]
        public JsonNetResult GetStudentForSubjectME(int ClassId, int? SectionId, int ExamTypeId,int SubjectId,bool FilterSection,int? BranchId=null)
        {
            var dataColl = new AcademicLib.BL.Exam.Transaction.MarksEntry(User.UserId, User.HostName, User.DBName).getStudentForMarkEntrySubWise(this.AcademicYearId, ClassId, SectionId, ExamTypeId,SubjectId,FilterSection,null,null,null,BranchId);
        ...
        [HttpPost]
        public JsonNetResult GetStudentsDetailsClassWise(int ClassId, int? SectionId, int SubjectId, bool FilterSection, int LessonId, DateTime TestDate, int EmployeeId, int? BatchId = null, int? SemesterId = null, int? ClassYearId = null)
        {
            ...
            try
            {
                dataColl = new AcademicLib.BL.Exam.Transaction.ClassTestMarkEntry(User.UserId, User.HostName, User.DBName).GetStudentsDetailsClassWise(0, this.AcademicYearId, ClassId, SectionId, SubjectId, FilterSection, LessonId, TestDate, EmployeeId, BatchId, SemesterId, ClassYearId);
                return new JsonNetResult() { Data = dataColl, TotalCount = dataColl.Count, IsSuccess = dataColl.IsSuccess, ResponseMSG = dataColl.ResponseMSG };
            }
            catch (Exception ee)
            {
        ...
        [HttpPost]
        public JsonNetResult getClassSummaryDetailsById(int ClassId, int EmployeeId, int SubjectId, int LessonId, DateTime TestDate)
        {
            ...
            try
            {
                dataColl = new AcademicLib.BL.Exam.Transaction.ClassSummary(User.UserId, User.HostName, User.DBName).GetClassSummaryDetailsById(0, this.AcademicYearId, ClassId, EmployeeId, SubjectId, LessonId, TestDate);
                return new JsonNetResult() { Data = dataColl, TotalCount = dataColl.Count, IsSuccess = dataColl.IsSuccess, ResponseMSG = dataColl.ResponseMSG };
            }
            catch (Exception ee)
            {
