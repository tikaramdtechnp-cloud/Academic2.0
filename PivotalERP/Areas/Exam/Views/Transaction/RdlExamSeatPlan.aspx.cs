...
{
    public partial class RdlExamSeatPlan : System.Web.Mvc.ViewPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack && !Loaded)
            {
                ...
                int entityId = (int)Dynamic.BusinessEntity.Global.RptFormsEntity.ExamSeatPlan;
                ...
                int examShiftId = Convert.ToInt32(Request["ExamShiftId"]);
                int fieldNameAs = Convert.ToInt32(Request["FieldNameAs"]);
                int examTypeId = Convert.ToInt32(Request["ExamTypeId"]);
                string roomIdColl = Convert.ToString(Request["RoomIdColl"]);
                ...
                var dataColl = new AcademicLib.BL.Exam.Transaction.ExamSeatPlan(user.UserId, user.HostName, user.DBName).GetExamSeatPlan(AcademicYearId, examTypeId, examShiftId,fieldNameAs,roomIdColl);
 
                ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("DataSet1", dataColl.ExamSeatPlanColl));
                ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("RoomSummaryDS", dataColl.RoomSummaryColl));
                ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("ClassSummaryDS", dataColl.ClassSummaryColl));
