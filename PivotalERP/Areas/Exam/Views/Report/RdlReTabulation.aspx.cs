...
{
    public partial class RdlReTabulation : System.Web.Mvc.ViewPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack && !Loaded)
            {
                ...
                int entityId = (int)Dynamic.BusinessEntity.Global.RptFormsEntity.ReExamTabulation;
                ...
                int reExamTypeId = Convert.ToInt32(Request["ReExamTypeId"]);
                int? studentId = null;
                ...
                var dataColl = new AcademicLib.BL.Exam.Transaction.MarksEntry(user.UserId, user.HostName, user.DBName).getReExamMarkSheetClassWise(AcademicYearId, studentId, classId, sectionId, examTypeId,reExamTypeId, FilterSection, classIdColl,branchId);
                ...
                {
                    rowSNO++;
                    bool hasReExam = dc.DetailsColl.Exists(p1 => p1.IsReExam == true); 
                    ...
                    foreach (var sd in dc.DetailsColl)
                    {
                        ...
                        if(hasReExam)
                            ...
                            tbl.IsReExam = sd.IsReExam;

                        tbl.PromotedClass = dc.PromotedClass;
                       // tbl.QrCode = dc.QrCode;
