...
namespace AcademicERP.Areas.Attendance.Views.Report
{
    public partial class RdlSalarySheet : System.Web.Mvc.ViewPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack && !Loaded)
            {
                ...
                var dataColl = new AcademicLib.BL.Payroll.SalarySheet(user.UserId, user.HostName, user.DBName).getSalarySheet(YearId, MonthId, CompanyIdColl, BranchIdColl, DepartmentIdColl, CategoryIdColl, EmployeeId, EmployeeIdColl);
