...
{
    public partial class RptFeeSummaryClassWise : System.Web.Mvc.ViewPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack && !Loaded)
            {
                ...
                int entityId = (int)Dynamic.BusinessEntity.Global.RptFormsEntity.FeeSummaryClassWise;
                ...
                var dataColl = new AcademicLib.BL.Fee.Transaction.FeeReceipt(user.UserId, user.HostName, user.DBName).getFeeSummaryClassWise(AcademicYearId, fromMonthId, toMonthId, forStudent);
