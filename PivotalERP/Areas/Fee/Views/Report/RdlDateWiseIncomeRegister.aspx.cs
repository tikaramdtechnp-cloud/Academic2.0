...
{
    public partial class RdlDateWiseIncomeRegister : System.Web.Mvc.ViewPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack && !Loaded)
            {
                ...
                int entityId = (int)Dynamic.BusinessEntity.Global.RptFormsEntity.DateWiseFeeIncomeRegister;
                ...
                int? fromReceiptNo = Convert.ToInt32(Request["fromReceiptNo"]);
                int? toReceiptNo = Convert.ToInt32(Request["toReceiptNo"]);
                ...
                var dataColl = new AcademicLib.BL.Fee.Transaction.FeeReceipt(user.UserId, user.HostName, user.DBName).getDateWiseFeeIncome(AcademicYearId, monthId, dateFrom, dateTo,fromReceiptNo,toReceiptNo);
