...
{
    public partial class RptFeeIncomeStudentWise : System.Web.Mvc.ViewPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack && !Loaded)
            {
                ...
                int entityId = (int)Dynamic.BusinessEntity.Global.RptFormsEntity.StudentWiseIncome;
                ...
                var dataColl = new AcademicLib.BL.Fee.Transaction.FeeReceipt(user.UserId, user.HostName, user.DBName).getFeeIncomeStudentWise(AcademicYearId, classId, sectionId, dateFrom,dateTo,feeItemIdColl);
