...
{
    public partial class RdlFeeSummaryPC : System.Web.Mvc.ViewPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack && !Loaded)
            {
                ...
                int entityId = (int)Dynamic.BusinessEntity.Global.RptFormsEntity.FeeSummary_PC;
                ...
                var dataColl = new AcademicLib.BL.Fee.Transaction.FeeReceipt(user.UserId, user.HostName, user.DBName).getFeeSummary_PC(AcademicYearId, fromMonthId, toMonthId, forStudent,"",null,null);
