...
{
    public partial class RptFeeSummaryStudentWise : System.Web.Mvc.ViewPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack && !Loaded)
            {
                ...
                int entityId = (int)Dynamic.BusinessEntity.Global.RptFormsEntity.FeeSummaryStudentWise;
                ...
                string classSection= Request["classSec"].ToString();
                ...
                string fromMonth = Request["fromMonth"].ToString();
                string toMonth = Request["toMonth"].ToString();
                ...
                parameterColl.Add(new Microsoft.Reporting.WebForms.ReportParameter("FromMonth", fromMonth));
                parameterColl.Add(new Microsoft.Reporting.WebForms.ReportParameter("ToMonth", toMonth));
                parameterColl.Add(new Microsoft.Reporting.WebForms.ReportParameter("ClassSectionName", classSection));
                ...
                var dataColl = new AcademicLib.BL.Fee.Transaction.FeeReceipt(user.UserId, user.HostName, user.DBName).getFeeSummaryStudentWise(AcademicYearId, classId,sectionId, fromMonthId, toMonthId, forStudent);
