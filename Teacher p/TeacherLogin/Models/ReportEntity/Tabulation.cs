...
namespace TeacherLogin.Models
{
    public class Tabulation
    {
        ...
        public string Sub_Grade_TH { get; set; }
        public string Sub_Grade_PR { get; set; }

        public string Sub_GP_Grade { get; set; }
        public string Sub_GP_Grade_TH { get; set; }
        public string Sub_GP_Grade_PR { get; set; }

        public double Sub_GP { get; set; }
        public double Sub_GP_TH { get; set; }
        public double Sub_GP_PR { get; set; }

        public double Sub_FMTH { get; set; }
        public double Sub_FMPR { get; set; }
        public double Sub_FM { get; set; }
        public double Sub_PMTH { get; set; }
        public double Sub_PMPR { get; set; }
        public double Sub_PM { get; set; }
