...
namespace TeacherLogin.Areas.OnlineClass.Controllers
{
    public class CreationController : TeacherLogin.Controllers.BaseController
    {
        ...
        [HttpPost]
        public TeacherLogin.Controllers.JsonNetResult GetSubjectList(TeacherLogin.Models.ExamSetupDetails W)
        {
            ...
            {                                
                ...
                Dictionary<string, string> keyValues = new Dictionary<string, string>();
                keyValues.Add("Bearer", User.access_token);
                var responseData = request.Execute<List<TeacherLogin.Models.Subject>>(W, keyValues);
