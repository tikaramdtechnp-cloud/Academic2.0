...
namespace TeacherLogin.Models
{
    ...
    public class APIRequest
    {
        ...
        public object Execute<TT>(object obj, Dictionary<string, string> headersKey = null)
        {
            ...
            var resStr = ReadResponse();
            return JsonConvert.DeserializeObject<TT>(resStr);
        }
    ...
    {
        public void SetAuthenticationToken(string name, bool isPersistant, TeacherLogin.Models.Teacher.TeacherLogin userData)
        {
            //string data = null;
            //if (userData != null)
            ...
            FormsAuthenticationTicket ticket = new FormsAuthenticationTicket(1, name, DateTime.Now, DateTime.Now.AddMinutes(300), isPersistant, data);
        ...
        public TeacherLogin.Models.Teacher.TeacherLogin GetUserData()
        {
            TeacherLogin.Models.Teacher.TeacherLogin userData = null;
            ...
            try
            {
                ...
                if (cookie != null)
                {
                    ...
                    userData = new JavaScriptSerializer().Deserialize(ticket.UserData, typeof(TeacherLogin.Models.Teacher.TeacherLogin)) as TeacherLogin.Models.Teacher.TeacherLogin;
