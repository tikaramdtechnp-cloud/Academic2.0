...
namespace StudentLogin.Controllers
{
    ...
    public class BaseController : Controller
    {
        ...
        protected virtual new StudentLogin.Models.Students.StudentUser User
        {
            get { return HttpContext.User as StudentLogin.Models.Students.StudentUser; }
        }

        protected StudentLogin.Models.Students.StudentUser UserDet
        {
            get
            {
                return new StudentLogin.Models.SessionContext().GetUserData();
            }
        }
        ...
        protected string BaseUrl = "";// "http://uat.mydynamicerp.com/v1/";
