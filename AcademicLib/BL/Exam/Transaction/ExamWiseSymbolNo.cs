...
{
    public class ExamWiseSymbolNo
    {
        DA.Exam.Transaction.ExamWiseSymbolNoDB db = null;
        int _UserId = 0;

        public ExamWiseSymbolNo(int UserId, string hostName, string dbName)
        {
            this._UserId = UserId;
            db = new DA.Exam.Transaction.ExamWiseSymbolNoDB(hostName, dbName);
        }
        ...
        public AcademicLib.BE.Exam.Transaction.ExamWiseSymbolNoCollections getSymbolNoForMarkImport()
        {
            ...
            public BE.Exam.Transaction.ExamWiseSymbolNoCollections GetAllExamWiseSymbolNo(int ClassId,int? SectionId,int ExamTypeId, bool FilterSection = true)
        {
            return db.getExamWiseSymbolNoClassWise(_UserId, ClassId, SectionId, ExamTypeId,FilterSection);
        }
