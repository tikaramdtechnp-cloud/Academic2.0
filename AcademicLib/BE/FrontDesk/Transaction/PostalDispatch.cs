...
{
   public class PostalDispatch : ResponeValues
    {
    ...
    public class PostalDispatchCollections : System.Collections.Generic.List<PostalDispatch>
    {
        public PostalDispatchCollections()
        {
            ResponseMSG = "";
        }
