...
namespace AcademicLib.DA.Library.Creation
{
    internal class DepartmentDB
    {
        ...
        public ResponeValues SaveUpdate(BE.Academic.Creation.Department beData, bool isModify)
        {
            ...
            if (isModify)
            {
                cmd.CommandText = "usp_UpdateBookDepartment";
            }
            else
            {
                cmd.Parameters[5].Direction = System.Data.ParameterDirection.Output;
                cmd.CommandText = "usp_AddBookDepartment";
            }
        ...
        public BE.Academic.Creation.DepartmentCollections getAllDepartment(int UserId, int EntityId)
        {
            BE.Academic.Creation.DepartmentCollections dataColl = new BE.Academic.Creation.DepartmentCollections();
            ...
            cmd.CommandText = "usp_GetAllBookDepartment";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
                    BE.Academic.Creation.Department beData = new BE.Academic.Creation.Department();
                    beData.DepartmentId = reader.GetInt32(0);
        ...
        public BE.Academic.Creation.Department getDepartmentById(int UserId, int EntityId, int DepartmentId)
        {
            BE.Academic.Creation.Department beData = new BE.Academic.Creation.Department();
            ...
            cmd.Parameters.AddWithValue("@UserId", UserId);
            cmd.Parameters.AddWithValue("@EntityId", EntityId);
            cmd.CommandText = "usp_GetBookDepartmentById";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
                    beData = new BE.Academic.Creation.Department();
                    beData.DepartmentId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.Name = reader.GetString(1);
                    if (!(reader[2] is DBNull)) beData.Code = reader.GetString(2);
                    if (!(reader[3] is DBNull)) beData.OrderNo = reader.GetInt32(3);
        ...
        public ResponeValues DeleteById(int UserId, int EntityId, int DepartmentId)
        {
            ...
            cmd.Parameters.AddWithValue("@EntityId", EntityId);
            cmd.Parameters.AddWithValue("@DepartmentId", DepartmentId);
            cmd.CommandText = "usp_DelBookDepartmentById";
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
            cmd.Parameters.Add("@IsSuccess", System.Data.SqlDbType.Bit);
            cmd.Parameters.Add("@ErrorNumber", System.Data.SqlDbType.Int);
