...
{
    internal class AllowClassDB
    {
        DataAccessLayer1 dal = null;
        public AllowClassDB(string hostName, string dbName)
        {
        ...
        public ResponeValues SaveUpdate(int UserId,AcademicLib.BE.Setup.AllowEntityAccessCollections dataColl)
        {
            ...
            { 
                ...
                cmd.CommandText = "ups_DelAllowClass";
                cmd.ExecuteNonQuery();
                ...
                resVal.ResponseMSG = "Allow User Wise Class Update Success";
        ...
        public BE.Setup.AllowEntityAccessCollections getAllowClassList(int UserId, int? ForUserId, int? ForGroupId)
        {
            ...
            cmd.CommandText = "usp_GetAllowClassList";
            try
            {
