...
{
    internal class AllowSectionDB
    {
        DataAccessLayer1 dal = null;
        public AllowSectionDB(string hostName, string dbName)
        {
        ...
        public ResponeValues SaveUpdate(int UserId, AcademicLib.BE.Setup.AllowEntityAccessCollections dataColl)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "ups_DelAllowSection";
                cmd.ExecuteNonQuery();
                ...
                resVal.ResponseMSG = "Allow User Wise Section Update Success";
        ...
        public BE.Setup.AllowEntityAccessCollections getAllowSectionList(int UserId, int? ForUserId, int? ForGroupId)
        {
            ...
            cmd.CommandText = "usp_GetAllowSectionList";
            try
            {
