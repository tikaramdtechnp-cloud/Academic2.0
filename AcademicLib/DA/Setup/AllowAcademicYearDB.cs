...
{
    internal class AllowAcademicYearDB
    {
        DataAccessLayer1 dal = null;
        public AllowAcademicYearDB(string hostName, string dbName)
        {
        ...
        public ResponeValues SaveUpdate(int UserId, AcademicLib.BE.Setup.AllowEntityAccessCollections dataColl)
        {
            ...
            { 
                ...
                cmd.CommandText = "ups_DelAllowAcademicYear";
                cmd.ExecuteNonQuery();
                ...
                resVal.ResponseMSG = "Allow User Wise AcademicYear Update Success";
        ...
        public BE.Setup.AllowEntityAccessCollections getAllowAcademicYearList(int UserId, int? ForUserId, int? ForGroupId)
        {
            ...
            cmd.CommandText = "usp_GetAllowAcademicYearList";
            try
            {
