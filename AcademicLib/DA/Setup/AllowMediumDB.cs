...
{
    internal class AllowMediumDB
    {
        DataAccessLayer1 dal = null;
        public AllowMediumDB(string hostName, string dbName)
        {
        ...
        public ResponeValues SaveUpdate(int UserId,AcademicLib.BE.Setup.AllowEntityAccessCollections dataColl)
        {
            ...
            { 
                ...
                cmd.CommandText = "ups_DelAllowMedium";
                cmd.ExecuteNonQuery();
                ...
                resVal.ResponseMSG = "Allow User Wise Medium Update Success";
        ...
        public BE.Setup.AllowEntityAccessCollections getAllowMediumList(int UserId, int? ForUserId, int? ForGroupId)
        {
            ...
            cmd.CommandText = "usp_GetAllowMediumList";
            try
            {
