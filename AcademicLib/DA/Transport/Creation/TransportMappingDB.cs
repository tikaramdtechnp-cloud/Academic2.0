...
{
    internal class TransportMappingDB : Dynamic.DataAccess.Common.CommonDB
    {
        DataAccessLayer1 dal = null;
        public TransportMappingDB(string hostName, string dbName)
        {
            dal = new DataAccessLayer1(hostName, dbName);
        }
        public ResponeValues SaveUpdate(int UserId,int AcademicYearId, BE.Transport.Creation.TransportMappingCollections dataColl)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "usp_DelTransportMapping";
                cmd.ExecuteNonQuery();


                foreach (var beData in dataColl)
                {
                    if (beData.StudentId > 0 && beData.PointId>0)
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        cmd.Parameters.Clear();

                        if (beData.RouteId.HasValue && beData.RouteId == 0)
                            beData.RouteId = null;

       

                        cmd.Parameters.AddWithValue("@StudentId", beData.StudentId);                        
                        cmd.Parameters.AddWithValue("@PointId",ZeroDBNull(beData.PointId));
                        cmd.Parameters.AddWithValue("@TravelType", beData.TravelType);
                        ...
                        cmd.CommandText = "usp_SaveTransportMapping";
                        ...
                        foreach (var m in beData.MonthIdColl)
                        {
                            ...
                            cmd.CommandText = "insert into tbl_TransportMappingMonth(TranId,MonthId,Rate,DiscountPer,DiscountAmt,PayableAmt,Remarks) values(@TranId,@MonthId,@Rate,@DiscountPer,@DiscountAmt,@PayableAmt,@Remarks)";
                            cmd.ExecuteNonQuery();
                        }
                ...
                resVal.ResponseMSG = "Transport Mapping Saved";
            }
        ...
        public ResponeValues SaveUpdateForMonth(int UserId, int AcademicYearId, int ForMonth)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@AcademicYearId", AcademicYearId);
                cmd.CommandText = "usp_AddTransportMappingForMonth";
                cmd.ExecuteNonQuery();


                dal.CommitTransaction();
                resVal.IsSuccess = true;
                resVal.ResponseMSG = "Transport Mapping Saved For Month";
            }
            catch (System.Data.SqlClient.SqlException ee)
            {
                resVal.IsSuccess = false;
        ...
        public BE.Transport.Creation.TransportMappingCollections getTransportMapping(int UserId, int AcademicYearId, int EntityId, int ClassId, int? SectionId)
        {
            BE.Transport.Creation.TransportMappingCollections dataColl = new BE.Transport.Creation.TransportMappingCollections();
            ...
            cmd.Parameters.AddWithValue("@SectionId", SectionId);
            cmd.Parameters.AddWithValue("@AcademicYearId", AcademicYearId);
            cmd.CommandText = "usp_GetTransportMapping";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
                    BE.Transport.Creation.TransportMapping beData = new BE.Transport.Creation.TransportMapping();
                    if (!(reader[0] is DBNull)) beData.StudentId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.PointId = reader.GetInt32(1);
                    if (!(reader[2] is DBNull)) beData.TravelType = reader.GetInt32(2);
                    ...
                    if (!(reader[7] is DBNull)) beData.RouteId = reader.GetInt32(7);
        ...
        public ResponeValues DeleteForMonth(int UserId, int AcademicYearId, int ForMonth)
        {
            ...
            cmd.Parameters.AddWithValue("@ForMonth", ForMonth);
            cmd.Parameters.AddWithValue("@AcademicYearId", AcademicYearId);
            cmd.CommandText = "usp_DelTransportMappingForMonth";
            try
            {
                cmd.ExecuteNonQuery();
                resVal.IsSuccess = true;
        ...
        public AcademicLib.RE.Transport.StudentSummaryCollections getStudentSummaryList(int UserId, int AcademicYearId, string ClassIdColl,string SectionIdColl,string RouteIdColl,string PointIdColl, string BatchIdColl, string SemesterIdColl, string ClassYearIdColl)
        {
            AcademicLib.RE.Transport.StudentSummaryCollections dataColl = new RE.Transport.StudentSummaryCollections();
            ...
            cmd.Parameters.AddWithValue("@RouteIdColl", RouteIdColl);
            ...
            cmd.CommandText = "usp_GetTransportStudentSummary";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
                    AcademicLib.RE.Transport.StudentSummary beData = new RE.Transport.StudentSummary();
                    ...
                    if (!(reader[34] is DBNull)) beData.RouteName = reader.GetString(34);
                    if (!(reader[35] is DBNull)) beData.PointName = reader.GetString(35);
                    if (!(reader[36] is DBNull)) beData.TravelType = reader.GetString(36);
                    if (!(reader[37] is DBNull)) beData.Rate = Convert.ToDouble(reader[37]);
                    if (!(reader[38] is DBNull)) beData.PickupTime = reader.GetString(38);
                    if (!(reader[39] is DBNull)) beData.DropTime = reader.GetString(39);

                    if (!(reader[40] is DBNull)) beData.ArrivalTime = reader.GetString(40);
                    if (!(reader[41] is DBNull)) beData.DepartureTime = reader.GetString(41);
                    if (!(reader[42] is DBNull)) beData.DuesAmt = Convert.ToDouble(reader[42]);
                    if (!(reader[43] is DBNull)) beData.DebitAmt = Convert.ToDouble(reader[43]);
                    if (!(reader[44] is DBNull)) beData.CreditAmt = Convert.ToDouble(reader[44]);
                    if (!(reader[45] is DBNull)) beData.Batch = reader.GetString(45);
                    if (!(reader[46] is DBNull)) beData.ClassYear = reader.GetString(46);
                    if (!(reader[47] is DBNull)) beData.Semester = reader.GetString(47);
                    if (!(reader[48] is DBNull)) beData.LedgerPanaNo = reader.GetString(48);
        ...
        public AcademicLib.RE.Transport.StudentSummaryCollections getStudentSummaryForMonth(int UserId, int AcademicYearId, int ForMonthId)
        {
            AcademicLib.RE.Transport.StudentSummaryCollections dataColl = new RE.Transport.StudentSummaryCollections();
            ...
            cmd.Parameters.AddWithValue("@AcademicYearId", AcademicYearId);
            cmd.CommandText = "usp_GetTransportStudentForMonth";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
