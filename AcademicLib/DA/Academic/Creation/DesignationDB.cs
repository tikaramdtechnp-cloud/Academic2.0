...
namespace AcademicLib.DA.Academic.Creation
{
    internal class DesignationDB
    {
        ...
        public ResponeValues SaveUpdate(BE.Academic.Creation.Designation beData, bool isModify)
        {
        ...
        public BE.Academic.Creation.DesignationCollections getAllDesignation(int UserId, int EntityId)
        {
            BE.Academic.Creation.DesignationCollections dataColl = new BE.Academic.Creation.DesignationCollections();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    BE.Academic.Creation.Designation beData = new BE.Academic.Creation.Designation();
                    beData.DesignationId = reader.GetInt32(0);
        ...
        public BE.Academic.Creation.Designation getDesignationById(int UserId, int EntityId, int DesignationId)
        {
            BE.Academic.Creation.Designation beData = new BE.Academic.Creation.Designation();
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    beData = new BE.Academic.Creation.Designation();
                    beData.DesignationId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.Code = reader.GetString(1);
                    if (!(reader[2] is DBNull)) beData.Name = reader.GetString(2);
                    if (!(reader[3] is DBNull)) beData.DisplayName = reader.GetString(3);
