...
namespace AcademicLib.DA.Academic.Transaction
{
    internal class StudentDB : Dynamic.DataAccess.Common.CommonDB
    {
        ...
        public AcademicLib.API.Student.StudentProfile getStudentForApp(int UserId,int AcademicYearId, int? StudentId, int? BatchId = null, int? ClassYearId = null, int? SemesterId = null)
        {
        ...
        public AcademicLib.BE.Academic.Transaction.StudentForTranCollections getStudentForTran(int UserId,int AcademicYearId, int ClassId,int? SectionId,int? ExamTypeId,int? BranchId=null)
        {
