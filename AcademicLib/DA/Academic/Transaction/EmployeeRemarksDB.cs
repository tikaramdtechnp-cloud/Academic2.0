...
{
    internal class EmployeeRemarksDB
    {
        DataAccessLayer1 dal = null;
        public EmployeeRemarksDB(string hostName, string dbName)
        {
            dal = new DataAccessLayer1(hostName, dbName);
        }
        public ResponeValues SaveUpdate(BE.Academic.Transaction.EmployeeRemarks beData, bool isModify)
        {
            ...
            cmd.Parameters.AddWithValue("@RemarksById", beData.RemarksById);
            ...
            if (isModify)
            {
                cmd.CommandText = "usp_UpdateEmployeeRemarks";
            }
            else
            {
                cmd.Parameters[8].Direction = System.Data.ParameterDirection.Output;
                cmd.CommandText = "usp_AddEmployeeRemarks";
            }
        ...
        public ResponeValues SaveUpdate(int UserId, List<BE.Academic.Transaction.EmployeeRemarks> dataColl)
        {
            ResponeValues resVal = new ResponeValues();
            ...
            try
            {
                ...
                resVal.ResponseMSG = "Employee Remarks Updated";
        ...
        public AcademicLib.BE.Academic.Transaction.EmployeeRemarksCollections getRemarks(int UserId, int EmployeeId)
        {
            AcademicLib.BE.Academic.Transaction.EmployeeRemarksCollections dataColl = new AcademicLib.BE.Academic.Transaction.EmployeeRemarksCollections();
            ...
            cmd.CommandText = "usp_GetAllEmployeeRemarks";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
                    AcademicLib.BE.Academic.Transaction.EmployeeRemarks beData = new BE.Academic.Transaction.EmployeeRemarks();
                    ...
                    if (!(reader[6] is DBNull)) beData.RemarksById = reader.GetInt32(6);
        ...
        public ResponeValues DeleteById(int UserId, int EntityId, int TranId)
        {
            ...
            cmd.CommandText = "usp_DelEmployeeRemarksById";
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
            cmd.Parameters.Add("@IsSuccess", System.Data.SqlDbType.Bit);
            cmd.Parameters.Add("@ErrorNumber", System.Data.SqlDbType.Int);
        ...
        public AcademicLib.RE.Academic.EmployeeRemarksCollections getRemarksList(int UserId, DateTime dateFrom, DateTime dateTo, int? remarksTypeId, int? EmployeeId, bool IsEmployeeUser = false, int? remarksFor = null)
        {
            AcademicLib.RE.Academic.EmployeeRemarksCollections dataColl = new RE.Academic.EmployeeRemarksCollections();
            ...
            cmd.Parameters.AddWithValue("@EmployeeId", EmployeeId);
            cmd.Parameters.AddWithValue("@IsEmployeeUser", IsEmployeeUser);
            cmd.Parameters.AddWithValue("@RemarksFor", remarksFor);
            cmd.CommandText = "usp_GetEmpRemarksList";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
                    AcademicLib.RE.Academic.EmployeeRemarks beData = new RE.Academic.EmployeeRemarks();
