...
{
    public class HealthExaminerDB
    {
        DataAccessLayer1 dal = null;
        public HealthExaminerDB(string hostName, string dbName)
        {
            dal = new DataAccessLayer1(hostName, dbName);
        }
        public Select2DataCollections GetUserNames(string terms)
        {
        ...
        public Select2DataCollections GetExaminerDetails(string terms)
        {
            Select2DataCollections dataColl = new Select2DataCollections();
            ...
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Terms", terms);
            cmd.CommandText = "usp_InfirmaryGetExaminerDetails";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
