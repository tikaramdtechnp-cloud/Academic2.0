...
{
    internal class EnquiryNumberMethodDB
    {
        DataAccessLayer1 dal = null;
        public EnquiryNumberMethodDB(string hostName, string dbName)
        {
            dal = new DataAccessLayer1(hostName, dbName);
        }

        public ResponeValues SaveUpdate(BE.FrontDesk.Transaction.EnquiryNumberMethod beData)
        {
            ...
            cmd.CommandText = "usp_AddEnquiryNumberMethod";
        ...
        public BE.FrontDesk.Transaction.EnquiryNumberMethod getConfiguration(int UserId, int EntityId, int? BranchId)
        {
            BE.FrontDesk.Transaction.EnquiryNumberMethod beData = new BE.FrontDesk.Transaction.EnquiryNumberMethod();
            ...
            cmd.CommandText = "usp_GetEnquiryNumberMethod";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
                    beData = new BE.FrontDesk.Transaction.EnquiryNumberMethod();
