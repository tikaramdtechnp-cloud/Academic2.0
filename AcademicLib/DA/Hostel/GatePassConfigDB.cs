...
{
    internal class GatePassConfigDB
    {
        DataAccessLayer1 dal = null;
        public GatePassConfigDB(string hostName, string dbName)
        {
            dal = new DataAccessLayer1(hostName, dbName);
        }
        public ResponeValues SaveUpdate(BE.Hostel.GatePassConfig beData)
        {
            ...
            cmd.CommandText = "usp_AddGatePassConfig";
        ...
        public BE.Hostel.GatePassConfig getConfiguration(int UserId, int EntityId, int? BranchId)
        {
            BE.Hostel.GatePassConfig beData = new BE.Hostel.GatePassConfig();
            ...
            cmd.CommandText = "usp_GetGatePassConfig";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
                    beData = new BE.Hostel.GatePassConfig();
