...
namespace AcademicLib.DA.Payroll
{
    internal class AllowExpenseCategoryDB
    {
        ...
        public ResponeValues UpdateAllowExpenseCategory(int UserId, List<AcademicLib.BE.Payroll.AllowExpenseCategory> DataColl)
        {
        ...
        public AcademicLib.BE.Payroll.EmployeeForAllowExpenseCategoryCollections getAllAllowExpenseCategory(int UserId, int EntityId, int? BranchId, int? DepartmentId, int? CategoryId)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    AcademicLib.BE.Payroll.EmployeeForAllowExpenseCategory beData = new AcademicLib.BE.Payroll.EmployeeForAllowExpenseCategory();
