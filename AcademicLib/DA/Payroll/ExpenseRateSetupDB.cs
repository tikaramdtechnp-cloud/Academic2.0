...
namespace AcademicLib.DA.Payroll
{
    internal class ExpenseRateSetupDB
    {
        ...
        public ResponeValues UpdateExpenseRateSetup(int UserId, List<AcademicLib.BE.Payroll.ExpenseRateSetup> DataColl)
        {
        ...
        public AcademicLib.BE.Payroll.EmployeeForExpenseRateSetupCollections getAllExpenseRateSetup(int UserId, int EntityId, int? BranchId, int? DepartmentId, int? CategoryId)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    AcademicLib.BE.Payroll.EmployeeForExpenseRateSetup beData = new AcademicLib.BE.Payroll.EmployeeForExpenseRateSetup();
