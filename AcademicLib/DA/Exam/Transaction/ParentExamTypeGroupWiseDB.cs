...
{
    internal class ParentExamTypeGroupWiseDB
    {
        DataAccessLayer1 dal = null;
        public ParentExamTypeGroupWiseDB(string hostName, string dbName)
        {
            dal = new DataAccessLayer1(hostName, dbName);
        }
        public ResponeValues SaveUpdate(BE.Exam.Transaction.ParentExamTypeGroupWise beData, bool isModify)
        {
            ...
            cmd.Parameters.AddWithValue("@ParentExamTypeGroupId", beData.ParentExamTypeGroupId);
            ...
            if (isModify)
            {
                cmd.CommandText = "usp_UpdateParentExamTypeGroupWise";
            }
            else
            {
                cmd.Parameters[10].Direction = System.Data.ParameterDirection.Output;
                cmd.CommandText = "usp_AddParentExamTypeGroupWise";
            }
        ...
        public BE.Exam.Transaction.ParentExamTypeGroupWiseCollections getAllParentExamTypeGroupWise(int UserId, int EntityId)
        {
            BE.Exam.Transaction.ParentExamTypeGroupWiseCollections dataColl = new BE.Exam.Transaction.ParentExamTypeGroupWiseCollections();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    BE.Exam.Transaction.ParentExamTypeGroupWise beData = new BE.Exam.Transaction.ParentExamTypeGroupWise();
                    beData.TranId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.ClassId = reader.GetInt32(1);
                    if (!(reader[2] is DBNull)) beData.SectionId = reader.GetInt32(2);
                    if (!(reader[3] is DBNull)) beData.ParentExamTypeGroupId = reader.GetInt32(3);
                    if (!(reader[4] is DBNull)) beData.TotalFailSubject = reader.GetInt32(4);
                    if (!(reader[5] is DBNull)) beData.IsSubjectWise = reader.GetBoolean(5);
                    if (!(reader[6] is DBNull)) beData.SubjectId = reader.GetInt32(6);
                    if (!(reader[7] is DBNull)) beData.IsTH = reader.GetBoolean(7);
                    if (!(reader[8] is DBNull)) beData.IsPR = reader.GetBoolean(8);
        ...
        public BE.Exam.Transaction.ParentExamTypeGroupWise getParentExamTypeGroupWiseById(int UserId, int EntityId, int TranId)
        {
            BE.Exam.Transaction.ParentExamTypeGroupWise beData = new BE.Exam.Transaction.ParentExamTypeGroupWise();
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    beData = new BE.Exam.Transaction.ParentExamTypeGroupWise();
                    beData.TranId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.ClassId = reader.GetInt32(1);
                    if (!(reader[2] is DBNull)) beData.SectionId = reader.GetInt32(2);
                    if (!(reader[3] is DBNull)) beData.ParentExamTypeGroupId = reader.GetInt32(3);
        ...
        public ResponeValues DeleteById(int UserId, int EntityId, int TranId)
        {
            ...
            cmd.Parameters.AddWithValue("@EntityId", EntityId);
            cmd.Parameters.AddWithValue("@TranId", TranId);
            cmd.CommandText = "usp_DelParentExamTypeGroupWiseById";
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
            cmd.Parameters.Add("@IsSuccess", System.Data.SqlDbType.Bit);
            cmd.Parameters.Add("@ErrorNumber", System.Data.SqlDbType.Int);
