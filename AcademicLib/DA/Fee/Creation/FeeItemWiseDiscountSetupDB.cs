...
{
    internal class FeeItemWiseDiscountSetupDB
    {
        DataAccessLayer1 dal = null;
        public FeeItemWiseDiscountSetupDB(string hostName, string dbName)
        {
        ...
        public ResponeValues SaveUpdate(int UserId,int AcademicYearId, BE.Fee.Creation.FeeItemWiseDiscountSetupCollections dataColl)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "usp_DelFeeItemDiscountSetup";
                cmd.ExecuteNonQuery();
                ...
                resVal.ResponseMSG = "FeeItem Wise Discount Setup Saved";
            }
        ...
        public BE.Fee.Creation.FeeItemWiseDiscountSetupCollections getFeeItemWiseDiscountSetup(int UserId, int AcademicYearId, int EntityId, int ClassId, int? SectionId, int? SemesterId, int? ClassYearId, int FeeItemId,int? BatchId)
        {
            ...
            cmd.Parameters.AddWithValue("@ClassYearId", ClassYearId);
            cmd.Parameters.AddWithValue("@BatchId", BatchId);
            cmd.CommandText = "usp_GetFeeItemDiscountSetup";
            try
            {
        ...
        public ResponeValues Delete(int UserId, int AcademicYearId, int EntityId, int ClassId, int? SectionId, int? SemesterId, int? ClassYearId, int FeeItemId)
        {
            ResponeValues resVal = new ResponeValues();
