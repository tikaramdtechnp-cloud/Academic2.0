...
namespace AcademicLib.RE.Exam
{
    public class MarkSheet
    {
        public MarkSheet()
        {
            DetailsColl = new List<MarkSheetDetails>();
            NoOfStudent = 1;
        }
        ...
        public List<MarkSheetDetails> DetailsColl { get; set; }
    ...
    public class MarkSheetCollections : System.Collections.Generic.List<MarkSheet> {
    ...
    public class MarkSheetDetails
    {
        ...
        public double CRGPTH { get; set; }
        public double CRGPPR { get; set; }
        public double CRGP { get; set; }
