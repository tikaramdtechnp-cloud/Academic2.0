...
{
    public class StudentMonthlyBIOSummary
    {
        public StudentMonthlyBIOSummary()
        {
            ClassName = "";
            SectionName = "";
        }
        ...
        public double TotalWeekend { get; set; }
    ...
    public class StudentMonthlyBIOSummaryCollections : System.Collections.Generic.List<StudentMonthlyBIOSummary>
    {
